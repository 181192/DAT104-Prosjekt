...
public class FormatertLiveTilbakemelding {
	private String tid;
	private Integer fornoyd;
	private Integer noytral;
	private Integer misfornoyd;

	public FormatertLiveTilbakemelding() {
		this.tid = "";
		this.fornoyd = 0;
		this.noytral = 0;
		this.misfornoyd = 0;
	...
	public FormatertLiveTilbakemelding(String tid, Integer fornoyd, Integer noytral, Integer misfornoyd) {
		super();
		this.tid = tid;
	...
	public String toString() {
		return ("Interval: " + this.tid + " Fornøyd: " + this.fornoyd + " Nøytral: " + this.noytral + " Misfornøyd: " + this.misfornoyd);
	}
}
