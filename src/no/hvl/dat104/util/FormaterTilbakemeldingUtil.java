...
//	public static List<FormatertTilbakemelding> formaterLiveTilbakemeldinger(List<LiveTilbakemelding> liste) {
//		if (!liste.isEmpty()) {
//			int last = 0;
//			for (Tilbakemelding tilbakemelding : liste) {
//				if (!tilbakemeldingMedSammeTidsStempelEksisterer(tilbakemelding.getTid())) {
...
//	 * @param stemme
//	 */
//	private static void finnLiveTilbakemeldingMedSammeTidOgLeggTilStemme(Timestamp tid, String stemme) {
//		for (FormatertTilbakemelding formatertTilbakemelding : formaterteTilbakemeldinger) {
//			if (formatertTilbakemelding.getTid().compareTo(tid) == 0) {
//				konverterStemmeOgInkrementerTilbakemelding(formatertTilbakemelding, stemme);
//			}
...
//	 * @param stemme
//	 */
//	private static void konverterStemmeOgInkrementerLiveTilbakemelding(FormatertTilbakemelding formatertTilbakemelding,
//			String stemme) {
//		switch (Integer.valueOf(stemme)) {
//		case 0:
//			formatertTilbakemelding.incrementFornoyd();
...
//	 * @return
//	 */
//	private static boolean liveTilbakemeldingMedSammeTidsStempelEksisterer(Timestamp tid) {
//		for (FormatertTilbakemelding ft : formaterteTilbakemeldinger) {
//			if (ft.getTid().compareTo(tid) == 0) {
//				return true;
//			}
